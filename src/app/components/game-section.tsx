...
<section
id=“game”
className={`relative min-h-screen flex items-center justify-center px-4 ${ isLandscapeMobile ? 'py-8' : 'py-20' }`}
>
    ...
    {(isPhone || isTablet) && started && !gameOver && (
      <div className={`mt-4 flex ${isLandscapeMobile ? 'flex-row items-end justify-between gap-4' : 'flex-col items-center gap-4'}`}>
        <div className={`grid grid-cols-3 select-none ${isTablet ? 'gap-3 w-[240px]' : 'gap-3 w-[210px]'}`}>
          <div />
          <button type="button" {...bindMoveBtn('w')} style={{ touchAction: 'none', WebkitUserSelect: 'none', userSelect: 'none', border: '1px solid rgba(255,74,74,0.45)', background: 'rgba(10,10,10,0.78)', color: '#F5F5F5', fontSize: isTablet ? '1.3rem' : '1.2rem', height: isTablet ? '64px' : '56px' }}>↑</button>
          <div />
          <button type="button" {...bindMoveBtn('a')} style={{ touchAction: 'none', WebkitUserSelect: 'none', userSelect: 'none', border: '1px solid rgba(255,74,74,0.45)', background: 'rgba(10,10,10,0.78)', color: '#F5F5F5', fontSize: isTablet ? '1.3rem' : '1.2rem', height: isTablet ? '64px' : '56px' }}>←</button>
          <button type="button" {...bindMoveBtn('s')} style={{ touchAction: 'none', WebkitUserSelect: 'none', userSelect: 'none', border: '1px solid rgba(255,74,74,0.45)', background: 'rgba(10,10,10,0.78)', color: '#F5F5F5', fontSize: isTablet ? '1.3rem' : '1.2rem', height: isTablet ? '64px' : '56px' }}>↓</button>
          <button type="button" {...bindMoveBtn('d')} style={{ touchAction: 'none', WebkitUserSelect: 'none', userSelect: 'none', border: '1px solid rgba(255,74,74,0.45)', background: 'rgba(10,10,10,0.78)', color: '#F5F5F5', fontSize: isTablet ? '1.3rem' : '1.2rem', height: isTablet ? '64px' : '56px' }}>→</button>
        </div>
